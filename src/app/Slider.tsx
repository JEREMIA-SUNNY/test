...
export default function SuggestedCarousel() {
  ...
  const assignRef = (index: number) => (el: HTMLLIElement | null) => {
                ...
                >
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          active &&
                            "text-lime-300 flex justify-center items-center text-center"
                        )}
                      >
                  ...
                  >
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="cursor-none text-xl font-bold leading-tight transition-colors group-hover:text-black"
                      draggable={false}
                      // onClick={disableDragClick}
