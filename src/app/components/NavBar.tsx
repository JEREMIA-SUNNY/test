...
const SubmenuItemService = () => {
  return (
    <motion.div
      ...
      className="text-black text-left  py-3 mt-4  px-4 text-sm rounded-xl flex flex-col gap-4 bg-white min-w-[200px]"
    >
      <div className=" hover:scale-105 transition-all  duration-300 ease-linear">
        BTA DRILLING
      </div>
      <div className="hover:scale-105 transition-all duration-300 ease-linear">
        CNC TURNING
